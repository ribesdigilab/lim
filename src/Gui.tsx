...
export function PigmentSelector({ test, pigments, currentColor, onSelect, onReset, onBack }: PigmentSelectorProps) {
  ...
  return (
    <div className="flex flex-col grid-cols-2 gap-4 relative h-full w-full pointer-events-none">
        ...
        <div className="absolute top-0 left-0 m-4 p-4 bg-black/20 shadow-lg rounded-xl backdrop-blur-sm pointer-events-autoz-50">
      ...
      <div>
        <div className="absolute top-0 right-0 m-4 p-4 bg-black/20 shadow-lg rounded-xl shadow-lg backdrop-blur-sm pointer-events-auto z-50">
